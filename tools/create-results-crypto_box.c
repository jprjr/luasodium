...
static void generate_crypto_box_easy(void) {
    int r;
    unsigned char sealed_message[crypto_box_SEALBYTES + 5];
    unsigned char unsealed_message[5];
    unsigned char seed[crypto_box_SEEDBYTES];
    unsigned char sender_pk[crypto_box_PUBLICKEYBYTES];
    unsigned char sender_sk[crypto_box_SECRETKEYBYTES];
    unsigned char receiver_pk[crypto_box_PUBLICKEYBYTES];
    ...
    memset(nonce,0,crypto_box_NONCEBYTES);
    memset(sealed_message,0,crypto_box_SEALBYTES + 5);
    memset(unsealed_message,0,5);
    ...
    r = crypto_box_seal(sealed_message, message, 5, receiver_pk);
    assert(r == 0);

    r = crypto_box_seal_open(unsealed_message, sealed_message, crypto_box_SEALBYTES + 5, receiver_pk, receiver_sk);
    assert(r == 0);

    r = memcmp(unsealed_message,message,5);
    assert(r == 0);
...
static void generate_crypto_box_curve25519xchacha20poly1305(void) {
    int r;
    unsigned char sealed_message[crypto_box_curve25519xchacha20poly1305_SEALBYTES + 5];
    unsigned char unsealed_message[5];
    unsigned char seed[crypto_box_curve25519xchacha20poly1305_SEEDBYTES];
    unsigned char sender_pk[crypto_box_curve25519xchacha20poly1305_PUBLICKEYBYTES];
    unsigned char sender_sk[crypto_box_curve25519xchacha20poly1305_SECRETKEYBYTES];
    unsigned char receiver_pk[crypto_box_curve25519xchacha20poly1305_PUBLICKEYBYTES];
    unsigned char receiver_sk[crypto_box_curve25519xchacha20poly1305_SECRETKEYBYTES];
    unsigned char nonce[crypto_box_curve25519xchacha20poly1305_NONCEBYTES];
    unsigned char beforenm_encrypt[crypto_box_curve25519xchacha20poly1305_BEFORENMBYTES];
    unsigned char beforenm_decrypt[crypto_box_curve25519xchacha20poly1305_BEFORENMBYTES];
    const unsigned char *message = (const unsigned char *) "hello";

    unsigned char cipher[crypto_box_curve25519xchacha20poly1305_MACBYTES + 5];

    memset(cipher,0,crypto_box_curve25519xchacha20poly1305_MACBYTES + 5);
    memset(nonce,0,crypto_box_curve25519xchacha20poly1305_NONCEBYTES);
    memset(sealed_message,0,crypto_box_curve25519xchacha20poly1305_SEALBYTES + 5);
    memset(unsealed_message,0,5);

    memset(seed,0,crypto_box_curve25519xchacha20poly1305_SEEDBYTES);
    crypto_box_curve25519xchacha20poly1305_seed_keypair(sender_pk,sender_sk,seed);
    memset(seed,0xff,crypto_box_curve25519xchacha20poly1305_SEEDBYTES);
    crypto_box_curve25519xchacha20poly1305_seed_keypair(receiver_pk,receiver_sk,seed);

    r = crypto_box_curve25519xchacha20poly1305_beforenm(beforenm_encrypt,receiver_pk,sender_sk);
    assert(r == 0);
    r = crypto_box_curve25519xchacha20poly1305_beforenm(beforenm_decrypt,sender_pk,receiver_sk);
    assert(r == 0);

    r = crypto_box_curve25519xchacha20poly1305_easy(cipher,message,5,nonce,receiver_pk,sender_sk);
    assert(r == 0);

    r = crypto_box_curve25519xchacha20poly1305_seal(sealed_message, message, 5, receiver_pk);
    assert(r == 0);

    r = crypto_box_curve25519xchacha20poly1305_seal_open(unsealed_message, sealed_message, crypto_box_curve25519xchacha20poly1305_SEALBYTES + 5, receiver_pk, receiver_sk);
    assert(r == 0);

    r = memcmp(unsealed_message,message,5);
    assert(r == 0);

    open_section("crypto_box_curve25519xchacha20poly1305_easy");
    dump_table("sender_pk",sender_pk,crypto_box_curve25519xchacha20poly1305_PUBLICKEYBYTES);
    dump_table("sender_sk",sender_sk,crypto_box_curve25519xchacha20poly1305_PUBLICKEYBYTES);
    dump_table("receiver_pk",receiver_pk,crypto_box_curve25519xchacha20poly1305_PUBLICKEYBYTES);
    dump_table("receiver_sk",receiver_sk,crypto_box_curve25519xchacha20poly1305_PUBLICKEYBYTES);
    dump_table("beforenm_encrypt",beforenm_encrypt,crypto_box_curve25519xchacha20poly1305_BEFORENMBYTES);
    dump_table("beforenm_decrypt",beforenm_decrypt,crypto_box_curve25519xchacha20poly1305_BEFORENMBYTES);
    dump_table("mac",&cipher[0],crypto_box_curve25519xchacha20poly1305_MACBYTES);
    dump_table("cipher",&cipher[crypto_box_curve25519xchacha20poly1305_MACBYTES],5);
...
int main(void) {
    ...
    generate_crypto_box_curve25519xchacha20poly1305();
