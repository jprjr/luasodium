...
luasodium_constant_t ls_crypto_secretstream_constants[] = {
    ...
    LS_CONST_PTR(crypto_secretstream_xchacha20poly1305_TAG_MESSAGE,crypto_secretstream_xchacha20poly1305_tag_message,3),
    LS_CONST_PTR(crypto_secretstream_xchacha20poly1305_TAG_PUSH,crypto_secretstream_xchacha20poly1305_tag_push,3),
    LS_CONST_PTR(crypto_secretstream_xchacha20poly1305_TAG_REKEY,crypto_secretstream_xchacha20poly1305_tag_rekey,3),
